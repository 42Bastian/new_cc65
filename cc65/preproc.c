...
int pp2(char *from, char *to, char *(*pfind) (char *), void (*prepl) (char *));
...
int
tok_assoc(char *sym, struct tok_elt *toks)
{
...
*/
int pp2(char *from, char *to, char *(*pfind) (char *),
        void(*prepl) (char *))
{
  int c;
  int no_chg;
...
*/
int
setmflag(int skip, int flag, int cond)
{
  if (skip) {
    s_ifdef[++i_ifdef] = 3;
    return (1);
